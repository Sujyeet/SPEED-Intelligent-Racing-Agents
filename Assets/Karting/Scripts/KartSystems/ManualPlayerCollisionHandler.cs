...
public class ManualPlayerCollisionHandler : MonoBehaviour
{
    ...
    public float GetCurrentPathDeviation()
    {
        ...
        Vector3 nearestDividerPos = Vector3.zero;
        ...
        foreach (var divider in dividers)
        {
            ...
            {
                minDistance = d;
                nearestDividerPos = dividerPos;
                foundNearest = true;
            }
        }
        
        // Debug visualization matching DRL agent exactly
        if (showPathDeviationDebug && foundNearest)
        {
            Debug.DrawLine(pos, nearestDividerPos, Color.yellow, 0.2f);
