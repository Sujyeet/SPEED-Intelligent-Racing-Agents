...
public sealed class NetworkedKartAnimState : NetworkBehaviour
{
    ...
    public readonly NetworkVariable<bool> Drifting = new(
    ...
    private void FixedUpdate()
    {
        ...
        // Drifting: compute from the owner's simulation
        Drifting.Value = (kart != null) && kart.IsDrifting && (kart.GroundPercent > 0.0f);
    }
}
